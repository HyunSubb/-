...
public class BroadCastingServer2 {
...
class Clinet3 implements Runnable{
    Socket socket;

    Clinet3(Socket socket) {
        this.socket = socket;
    }

    @Override
    public void run() {
        new Thread(new InputStream3(socket)).start();
